...
make_plot(
  ...
  end_date = clock::date_build(2025, 7, 1),
...
make_plot(
  ...
  scaling_var = "per_pop",
  start_date = clock::date_build(2022, 3, 1),
  end_date = clock::date_build(2025, 6, 1),
...
make_plot(
  ...
  scaling_var = "per_pop_cumsum",
  start_date = clock::date_build(2022, 3, 1),
  end_date = clock::date_build(2025, 4, 1),
...
make_samantekt(
  height = 1 * 16,
  width = 16,
  end_date = clock::date_build(c(2025, 2025, 2025), c(6, 4, 6)),
  number_labels = label_number(big.mark = ".", decimal.mark = ",")
)
```

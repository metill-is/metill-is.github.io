...
image: Figures/election_prediction.png
---
...
![](Figures/election_prediction_prev.png){.column-page}

:::

Hér að ofan má sjá nýjustu spána um úrslit alþingiskosninganna, en hún byggir á gögnum fram til 8. nóvember. Spáin byggir á 4 þúsund hermunum úr tölfræðilíkaninu okkar, en það þýðir að við notum bestu fyrirliggjandi gögn og látum líkanið búa til 4 þúsund ólíkar sviðsmyndir um hvernig fylgið gæti þróast fram til kjördags. 

Dálkurinn „spá“ sýnir miðgildi allra þessara ólíku sviðsmynda og það sem við myndum að jafnaði búast við að yrði fylgi flokka í kosningunum. Það er hins vegar enn langt til kosninga og margt sem getur gerst fram að kjördegi. Dálkarnir undir ,,90% óvissubil" ná utan um þessa óvissu með því að sýna á hvaða bili 9 af hverjum 10 sviðsmyndum okkar liggja í kringum miðgildið. Öll gildi á þessu bili má segja að séu raunhæf þegar kemur að líklegum niðurstöðum kosninganna eins og staðan er í dag.

*Vegna námundunar getur summa fylgis allra flokkanna verið önnur en 100%.*
